    ...
    public class TextBox
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            if (Loaded)
            {
                ...
                spriteBatch.DrawString(Rpg.Font, text + pointer, new Vector2(position.X + 3, position.Y + 2), Color.Black, 0, new Vector2(), 1, SpriteEffects.None, 0.882f);
            }
        }
        #region Text Entry
        void TextEntry()
        {
            ...
            if (text.Length < maxChars)
            {
                ...
                else
                {
                    ...
                    if (Rpg.keyboard.JustPressed(Keys.NumPad0))
                    {
                        text += "0";
                    }
                    if (Rpg.keyboard.JustPressed(Keys.NumPad1))
                    {
                        text += "1";
                    }
                    if (Rpg.keyboard.JustPressed(Keys.NumPad2))
                    {
                        text += "2";
                    }
                    if (Rpg.keyboard.JustPressed(Keys.NumPad3))
                    {
                        text += "3";
                    }
                    if (Rpg.keyboard.JustPressed(Keys.NumPad4))
                    {
                        text += "4";
                    }
                    if (Rpg.keyboard.JustPressed(Keys.NumPad5))
                    {
                        text += "5";
                    }
                    if (Rpg.keyboard.JustPressed(Keys.NumPad6))
                    {
                        text += "6";
                    }
                    if (Rpg.keyboard.JustPressed(Keys.NumPad7))
                    {
                        text += "7";
                    }
                    if (Rpg.keyboard.JustPressed(Keys.NumPad8))
                    {
                        text += "8";
                    }
                    if (Rpg.keyboard.JustPressed(Keys.NumPad9))
                    {
                        text += "9";
                    }
                    if (Rpg.keyboard.JustPressed(Keys.A))
