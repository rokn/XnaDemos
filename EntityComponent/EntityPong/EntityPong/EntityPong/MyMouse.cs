...
namespace EntityPong
{
    public class MyMouse : DrawableGameComponent
    {
        ...
        //public static Vector2 RealPosition { get { return Pong.camera.GetRealMousePosition(); } }
        ...
        public MyMouse(Pong game, Color defaultColor)
            : base(game)
        {
            currentmouse = new MouseState();
            oldmouse = new MouseState();
            position = new Vector2(EntitySystem.BlackBoard.GetEntry<int>("WindowWidth") / 2, EntitySystem.BlackBoard.GetEntry<int>("WindowHeight") / 2);
            leftIsHeld = false;
            rightIsHeld = false;
            screenwidth = EntitySystem.BlackBoard.GetEntry<int>("WindowWidth");
            screenheight = EntitySystem.BlackBoard.GetEntry<int>("WindowHeight");            
        ...
        {
            spriteBatch = new SpriteBatch(EntitySystem.BlackBoard.GetEntry<GraphicsDevice>("GraphicsDevice"));
