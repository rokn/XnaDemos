...
namespace TopScrollingGame
{
    public class MouseCursor
    {
        ...
        public void UpdateMouse(GameTime gameTime)
        {
            ...
            Vector2 scalingFactor = new Vector2(Main.baseScreenSize.X / Main.width, Main.baseScreenSize.Y / Main.height);
            position.X = currentmouse.X * scalingFactor.X;
            position.Y = currentmouse.Y * scalingFactor.Y;
