...
namespace StealthOrNot
{
    ...
    public static class GUI
    {
        ...
        public static void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(Main.Font, "Rays: " + Main.raysCast, new Vector2(20, 100), Color.White, 0, new Vector2(), 1f, SpriteEffects.None, 0.891f);

            if (Main.MainPlayer != null)
            {
                spriteBatch.DrawString(Main.Font, "Name: " + Main.MainPlayer.Name, new Vector2(20, 130), Color.White, 0, new Vector2(), 1f, SpriteEffects.None, 0.891f);
                spriteBatch.DrawString(Main.Font, "Position: " + Main.MainPlayer.Position, new Vector2(20, 160), Color.White, 0, new Vector2(), 1f, SpriteEffects.None, 0.891f);
            }
        }
