...
namespace TheSpirit
{
    public class MouseCursor : DrawableGameComponent
    {
        ...
        public MouseCursor(Game game, int windowwidth, int windowheight, float doubleClickTime)
            : base(game)
        {
        ...
        protected override void LoadContent()
        {
            ...
            texture = Scripts.LoadTexture("Mouse");
        }
        ...
        {
            return oldmouse.ScrollWheelValue < currentmouse.ScrollWheelValue;
        }
