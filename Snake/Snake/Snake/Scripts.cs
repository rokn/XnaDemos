...
namespace Snake
{
    public static class Scripts
    {
        ...
        public static Vector2 GetPositionOfGridPlace(int x, int y)
        {
            Vector2 pos = new Vector2();

            pos.X = Main.playingGroundPosition.X + x * TileSet.TileWidth;
            pos.Y = Main.playingGroundPosition.Y + y * TileSet.TileHeight;

            return pos;
        }

        public static Vector2 GetPositionOfGridPlace(Point point)
        {
            Vector2 pos = new Vector2();

            pos.X = Main.playingGroundPosition.X + point.X * TileSet.TileWidth;
            pos.Y = Main.playingGroundPosition.Y + point.Y * TileSet.TileHeight;

            return pos;
        }

        public static bool IsSameAs(this Point p, Point point)
        {
            bool isSame = true;
